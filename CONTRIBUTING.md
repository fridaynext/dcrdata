...
1. Fork the repository on GitHub.  Just click the little Fork button at https://github.com/fridaynext/dcrdata
...
At the [main dcrdata repo page](https://github.com/fridaynext/dcrdata) (not your fork) you may find a button suggesting that you might want to create a PR from a branch you just pushed. "Compare & pull request" it will say on a big green button. Click it and it will start form to open a new pull request. Always:
