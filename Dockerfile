...
ENV DCRSRC_PATH=$GOPATH/src/github.com/fridaynext/dcrdata/
ENV GO111MODULE=on
...
#  docker run -ti --entrypoint=/bin/bash -v ${PWD}:${PWD}:/home/decred/go/src/github.com/fridaynext/dcrdata --rm decred/dcrdata